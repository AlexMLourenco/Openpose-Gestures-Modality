...
OPEN_POSE_DIR = "C:\\Users\\AlexandreLourenco\\Desktop\\openpose-1.5.1-binaries-win64-only_cpu-python-flir-3d\\openpose"
...
vid_dir = 'videos' #'20bn-datasets/20bn-jester-v1'
json_dir = 'json'
log_dir = 'logs'
label_dir = 'labels'
script_dir = 'scripts'
